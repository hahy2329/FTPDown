            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                        <img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/about.png">
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="d-inline-block border rounded-pill text-primary px-4 mb-3">About Us </div>
                        <h2 class="mb-4">${sessionScope.userid }</h2>
            ...
            <div class="container px-lg-5">
                <div class="row align-items-center" style="height: 250px;">
                    ...
                    <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                        <img class="img-fluid mt-5" style="max-height: 250px;" src="${contextPath }/resources/bizconsult-1.0.0/img/newsletter.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-xxl bg-primary my-6 py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="owl-carousel client-carousel">
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-1.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-2.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-3.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-4.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-5.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-6.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-7.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="${contextPath }/resources/bizconsult-1.0.0/img/logo-8.png" alt=""></a>
                </div>
            </div>
        </div>
        <!-- Client End -->
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            ...
                            <img class="img-fluid rounded-circle w-100 mb-4" src="${contextPath }/resources/bizconsult-1.0.0/img/team-1.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="${contextPath }/resources/bizconsult-1.0.0/img/team-2.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="${contextPath }/resources/bizconsult-1.0.0/img/team-3.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="${contextPath }/resources/bizconsult-1.0.0/img/team-4.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
